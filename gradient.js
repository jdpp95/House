class Gradient {
    ...
    constructor(timeTransformer) {
        ...
        let rawHourlyWeather = {
            ...
            "-6": { temperature: -0.5, clouds: 1 },
            "-5": { temperature: -1, clouds: 1 },
            "-4": { temperature: -1, clouds: 0.5 },
            "-3": { temperature: -1, clouds: 1 },
            "-2": { temperature: -1, clouds: 1 },
            "-1": { temperature: -1, clouds: 1 },
            0: { temperature: -2, clouds: 0.75 },
            1: { temperature: -3, clouds: 1.25 },
            2: { temperature: -3, clouds: 1 },
            3: { temperature: -3, clouds: 1.25 },
            4: { temperature: -4, clouds: 0.75 },
            5: { temperature: -4, clouds: 0.85 },
            6: { temperature: -4, clouds: 0.85 },
            7: { temperature: -3, clouds: 0.85 },
            8: { temperature: -2, clouds: 0.85 },
            9: { temperature: -2, clouds: 0.85 },
            10: { temperature: 1, clouds: 0.85 },
            11: { temperature: 0, clouds: 0.85 },
            12: { temperature: 2, clouds: 0.85 },
            16: { temperature: -2.1, clouds: 1.1 },
            17: { temperature: -4.7, clouds: 1 },
            18: {   temperature: -6.1, clouds: 0.9 },
